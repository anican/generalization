...
def print_params_info(num_hiddens,
                      num_residual_layers,
                      ...
                      commitment_cost,
                      decay):
    print('\nModel Configuration:\n \tnum_hiddens:{}'.format(num_hiddens))
    print('\tnum_residual_layers:{}'.format(num_residual_layers))
    print('\tnum_residual_hiddens:{}'.format(num_residual_hiddens))
    print('\tnum_embeddings:{}'.format(num_embeddings))
    print('\tembedding_dim:{}'.format(embedding_dim))
    print('\tcommitment_cost:{}'.format(commitment_cost))
    print('\tdecay:{}\n'.format(decay))
...
class Model(nn.Module):
    ...
    def __init__(self, num_hiddens, num_residual_layers, num_residual_hiddens,
        ...
        print_params_info(num_hiddens=num_hiddens,
...
def _test_input_output_shape():
    ...
    y = model(x)
    print(y[1].shape)
    assert x.shape == y[1].shape
    print('Success!')


if __name__ == '__main__':
    _test_input_output_shape()
